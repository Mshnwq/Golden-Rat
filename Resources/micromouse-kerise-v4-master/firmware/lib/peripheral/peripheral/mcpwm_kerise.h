...
typedef mcpwm_output_action_2_t mcpwm_action_on_pwmxa_t;
...
typedef mcpwm_output_action_2_t mcpwm_action_on_pwmxb_t;
...
typedef struct {
    ...
    mcpwm_duty_type_2_t duty_mode;     /*!<Set type of duty cycle*/
    mcpwm_counter_type_2_t counter_mode;  /*!<Set  type of MCPWM counter*/
} mcpwm_config_t;
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t mcpwm_set_duty_type(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_generator_t gen, mcpwm_duty_type_2_t duty_type);
...
*     - frequency of timer
*/
// uint32t mcpwm_get_frequency(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t mcpwm_deadtime_enable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_deadtime_type_2_t dt_mode,
...
esp_err_t mcpwm_fault_set_oneshot_mode(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_fault_signal_t fault_sig,
                                       mcpwm_output_action_2_t action_on_pwmxa, mcpwm_output_action_2_t action_on_pwmxb);
...
esp_err_t mcpwm_capture_enable(mcpwm_unit_t mcpwm_num, mcpwm_capture_signal_t cap_sig, mcpwm_capture_on_edge_2_t cap_edge,
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t mcpwm_sync_enable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_sync_signal_2_t sync_sig,
                            uint32_t phase_val);
